        ...
        <div class="tw-h-full tw-flex tw-flex-col">
            <div class="tw-p-6 tw-text-white tw-relative tw-overflow-hidden" :style="headerStyle">
                <div class="tw-absolute tw-top-2 tw-left-2 tw-z-10">
                    <q-btn round flat icon="photo_camera" size="sm"
                ...
                <input ref="bgInput" type="file" accept="image/*" class="hidden-input"
                ...
                <div class="tw-absolute tw-top-2 tw-right-2 tw-z-10">
                    <q-btn flat round dense icon="close" @click="isOpen = false"
                        class="tw-text-white tw-bg-black/30 tw-backdrop-blur-sm hover:tw-bg-black/50 tw-drop-shadow-[2px_2px_4px_rgba(0,0,0,0.8)]" />
                </div>
                <div class="tw-mb-4 tw-mt-10 tw-relative tw-z-10">
                    <h3
                        class="tw-text-xl tw-font-bold tw-drop-shadow-[2px_2px_4px_rgba(0,0,0,0.8)] tw-drop-shadow-[0_0_8px_rgba(0,0,0,0.5)]">
                        Profile</h3>
                </div>
                <div class="tw-text-center tw-relative tw-z-10">
                    <q-avatar size="100px" class="tw-mb-4 tw-cursor-pointer tw-border-4 tw-border-white tw-shadow-2xl"
                    ...
                    <div
                        ...
                        {{ userName }}</div>
                    <div
                        class="tw-mt-1 tw-drop-shadow-[2px_2px_4px_rgba(0,0,0,0.8)] tw-drop-shadow-[0_0_8px_rgba(0,0,0,0.5)]">
                        {{ unit }}</div>
                </div>
            </div>
            <div class="tw-flex-1 tw-overflow-auto tw-p-6 tw-bg-white">
                <div class="tw-space-y-4">
                    <div class="tw-text-sm tw-text-gray-500 tw-uppercase tw-font-semibold tw-mb-4">Account Information
                    </div>
                    ...
                    <div v-else-if="userProfile" class="tw-space-y-3">
                        <div class="tw-flex tw-items-center tw-p-3 tw-bg-gray-50 tw-rounded-lg">
                            ...
                            <div>
                                ...
                                <div class="tw-text-sm tw-font-semibold">{{ userProfile.nik }}</div>
                            </div>
                        </div>
                        <div class="tw-flex tw-items-center tw-p-3 tw-bg-gray-50 tw-rounded-lg">
                            ...
                            <div>
                                ...
                                <div class="tw-text-sm tw-font-semibold">{{ userProfile.name }}</div>
                            </div>
                        </div>
                        <div class="tw-flex tw-items-center tw-p-3 tw-bg-gray-50 tw-rounded-lg">
                            ...
                            <div>
                                ...
                                <div class="tw-text-sm tw-font-semibold">{{ userProfile.jabatan || '-' }}</div>
                            </div>
                        </div>
                        <div class="tw-flex tw-items-center tw-p-3 tw-bg-gray-50 tw-rounded-lg">
                            ...
                            <div>
                                ...
                                <div class="tw-text-sm tw-font-semibold">{{ userProfile.dir_name || '-' }}</div>
                            </div>
                        </div>
                        <div class="tw-flex tw-items-center tw-p-3 tw-bg-gray-50 tw-rounded-lg">
                            ...
                            <div>
                                ...
                                <div class="tw-text-sm tw-font-semibold">{{ userProfile.div_name || '-' }}</div>
                            </div>
                        </div>
                        <div class="tw-flex tw-items-center tw-p-3 tw-bg-gray-50 tw-rounded-lg">
                            ...
                            <div>
                                ...
                                <div class="tw-text-sm tw-font-semibold">{{ userProfile.dept_name || '-' }}</div>
                            </div>
                        </div>
                    </div>
                </div>
...
/> -->
                <q-btn unelevated label="Logout" icon="logout" color="red-6" @click="$emit('logout')"
                    class="tw-w-full tw-font-semibold" />
            </div>
        </div>
    </q-drawer>

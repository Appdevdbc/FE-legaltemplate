    ...
    <q-card class="tw-shadow-2xl tw-rounded-2xl tw-overflow-hidden">
      ...
      <q-card-section class="tw-bg-white">
        ...
        >
          ...
          <template v-slot:body-cell-bu_status="props">
              <q-td :props="props">
...
const columns = [
  ...
  { name: "bu_id", label: "Kode Bisnis Unit", field: "bu_id", align: "left", sortable: true },
  { name: "bu_name", label: "Nama Bisnis Unit", field: "bu_name", align: "left", sortable: true },
  { name: "bu_status", label: "Status", field: "bu_status", align: "left", sortable: true },
...
const loadRoles = async () => {
  loading.value = true;
  try {
    const res = await axios.get(`${import.meta.env.VITE_API}listBu`);
